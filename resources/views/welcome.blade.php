        ...
        <section id="pricing" class="pricing">
            <div id="w">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <ul id="menu-pricing" class="menu-price clearfix">

                                @foreach($items as $item)
                                    <li class="item {{ $item->category->id }}">
                                        <a href="#">
                                            <img src="{{ asset('public/uploads/item/'.$item->image) }}" class="img-responsive" alt="{{ $item->image }}" >
